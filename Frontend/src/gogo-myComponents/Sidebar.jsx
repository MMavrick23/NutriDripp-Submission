...
import InstallPWA from "../gogo-myComponents/InstallPWA";
  ...
  filteredList = (menuItems) => {
    ...
    if (roles) {
      return menuItems.filter((menuItem) => {
        if (menuItem.roles)
          return menuItem.roles.some((role) => {return roles.includes(role.toString())});
        return true
      })
    } else {
      return menuItems;
        ...
        <div className="main-menu">
          <div className="scroll">
            ...
            >
              ...
              <InstallPWA>
                <Nav key={"install-app"} className="d-flex justify-content-center" style={{borderBottom: "1px solid #f3f3f3", padding: 20, cursor: "pointer"}}>
                  <NavItem>
                      <i className={"iconsminds-down-1"}/>{' '}
                  </NavItem>
                  <NavItem>
                    {document.getElementsByTagName('html')[0].getAttribute('dir') === "rtl" ? "تحميل التطبيق" : "Install App"}
                  </NavItem>
                </Nav>
              </InstallPWA>
